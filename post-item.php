            ...
            <div>
                <div class="form-group">
                    ...
                    <select name="type" class="form-control" style="padding-left: 20px;">
                        <option value="lost" <?php echo (isset($_GET['type']) && $_GET['type'] == 'lost') ? 'selected' : ''; ?> <?php echo (isset($_GET['type']) && $_GET['type'] == 'found') ? 'disabled style="display:none;"' : ''; ?>><?php echo __('i_lost_something'); ?></option>
                        <option value="found" <?php echo (isset($_GET['type']) && $_GET['type'] == 'found') ? 'selected' : ''; ?> <?php echo (isset($_GET['type']) && $_GET['type'] == 'lost') ? 'disabled style="display:none;"' : ''; ?>><?php echo __('i_found_something'); ?></option>
                    </select>
                </div>
                <div class="form-group">
